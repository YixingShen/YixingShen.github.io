...
CMOS Sensor DVP, HD/SDTV Bit-Parallel Interface, CVBS, HDMI, MIPI CSI-2, SDI, LVDS,   
...
Develop develop windows/console application using C# .NET and WIN32 API DLL for Avisonic EVB.    
